...
int EyeAsef::asef_initialze(AsefEyeLocator *asef, const char *asef_file_name) {

	if ( !asef || !asef_file_name || strlen(asef_file_name)==0)
		return -1;
...
void EyeAsef::asef_destroy(AsefEyeLocator *asef){
...
void EyeAsef::asef_locate_eyes(AsefEyeLocator *asef){
...
int EyeAsef::load_asef_filters(const char* file_name, int *p_n_rows, int *p_n_cols, 
...
int EyeAsef::read_line(FILE* fp, char* buf, int size){
	int c, i = 0;
